...
#import data
data = pd.read_csv("grocery_data2.csv",engine='python')
...
def main(argv):
    print('Args : ',argv)
    userid = int(argv[0])
    print('Predicition : ',predict(userid, 10, False))
    print('Predicition Type: ',type(predict(userid, 10, False)))
